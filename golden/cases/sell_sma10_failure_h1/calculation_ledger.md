# Calculation ledger: sell_sma10_failure_h1

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: SELL rejection fails only its SMA10 touch boundary.
- Evaluation boundary: `2026-02-03T11:00:01Z`
- Signal timeframe: `H1`
- Data status: `READY`
- Coverage: `sma10_failure`, `sell`
...
- SMA10 / SMA20: `751.3` / `749.4`
- Wilder D1 ATR(5): `16.0`
- Activation buffer (ATR × 0.05): `0.8`
- Daily raw low / high: `742.0` / `758.0`
- Daily BUY / SELL level: `742.8` / `757.2`
- Recent 21-bar low / high: `737.0` / `770.0`
...
- BUY pivot / window extreme: `737.0` / `737.0`
- SELL pivot / window extreme: `770.0` / `770.0`
