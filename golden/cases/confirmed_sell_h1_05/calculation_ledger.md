# Calculation ledger: confirmed_sell_h1_05

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H1 confirmed SELL candidate (variant 5).
- Evaluation boundary: `2026-02-03T11:00:01Z`
- Signal timeframe: `H1`
- Data status: `READY`
- Coverage: `confirmed_sell`, `h1`, `risk_usd_100`, `below_provider_minimum`, `provider_stop_adjustment`
