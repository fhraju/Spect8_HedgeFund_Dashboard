# Calculation ledger: filtered_sell_h1_02

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H1 SELL Filter matched while the SELL technical signal is false (variant 2).
...
- BUY pivot / window extreme: `145.0` / `145.0`
- SELL pivot / window extreme: `157.5` / `157.5`
