# Calculation ledger: filtered_buy_h4_02

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H4 BUY Filter matched while the BUY technical signal is false (variant 2).
- Evaluation boundary: `2026-02-07T20:00:01Z`
- Signal timeframe: `H4`
- Data status: `READY`
- Coverage: `filtered_buy_only`, `h4`
...
- SMA10 / SMA20: `150.4` / `150.2`
- Wilder D1 ATR(5): `16.0`
- Activation buffer (ATR × 0.05): `0.8`
- Daily raw low / high: `142.0` / `158.0`
- Daily BUY / SELL level: `142.8` / `157.2`
- Recent 21-bar low / high: `142.5` / `155.0`
...
- BUY pivot / window extreme: `142.5` / `142.5`
- SELL pivot / window extreme: `155.0` / `155.0`
