# Calculation ledger: technical_buy_without_filter_h4
...
- Signal timeframe: `H4`
- Data status: `READY`
- Coverage: `technical_signal_without_filter`, `buy`, `h4`
...
- SMA10 / SMA20: `650.1` / `650.05`
- Wilder D1 ATR(5): `16.0`
- Activation buffer (ATR × 0.05): `0.8`
- Daily raw low / high: `642.0` / `658.0`
- Daily BUY / SELL level: `642.8` / `657.2`
- Recent 21-bar low / high: `647.0` / `653.0`
...
- BUY pivot / window extreme: `647.0` / `647.0`
- SELL pivot / window extreme: `653.0` / `653.0`
