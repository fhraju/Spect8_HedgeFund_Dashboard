# Calculation ledger: filtered_buy_h4_03

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H4 BUY Filter matched while the BUY technical signal is false (variant 3).
...
- SMA10 / SMA20: `175.4` / `175.2`
- Wilder D1 ATR(5): `16.0`
- Activation buffer (ATR × 0.05): `0.8`
- Daily raw low / high: `167.0` / `183.0`
- Daily BUY / SELL level: `167.8` / `182.2`
- Recent 21-bar low / high: `167.5` / `180.0`
...
- BUY pivot / window extreme: `167.5` / `167.5`
- SELL pivot / window extreme: `180.0` / `180.0`
