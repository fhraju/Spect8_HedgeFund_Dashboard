# Calculation ledger: missing_daily_candle

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: A missing D1 interval quarantines the daily reference stream.
- Evaluation boundary: `2026-02-03T11:00:01Z`
- Signal timeframe: `H1`
- Data status: `UNAVAILABLE`
- Coverage: `missing_candle`, `missing_daily_candle`, `data_unavailable`
