# Calculation ledger: buy_sma10_failure_h1

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: BUY rejection fails only its SMA10 touch boundary.
- Evaluation boundary: `2026-02-03T11:00:01Z`
- Signal timeframe: `H1`
- Data status: `READY`
- Coverage: `sma10_failure`, `buy`
...
- SMA10 / SMA20: `723.7` / `725.6`
- Wilder D1 ATR(5): `16.0`
- Activation buffer (ATR × 0.05): `0.8`
- Daily raw low / high: `717.0` / `733.0`
- Daily BUY / SELL level: `717.8` / `732.2`
- Recent 21-bar low / high: `717.5` / `738.0`
...
- BUY pivot / window extreme: `717.5` / `717.5`
- SELL pivot / window extreme: `738.0` / `738.0`
