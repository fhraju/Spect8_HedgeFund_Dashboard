# Calculation ledger: duplicate_signal_candle

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: A duplicate H1 candle is rejected before strategy calculation.
- Evaluation boundary: `2026-02-03T11:00:01Z`
- Signal timeframe: `H1`
- Data status: `UNAVAILABLE`
- Coverage: `duplicate_candle`, `duplicate_signal_candle`, `data_unavailable`
...
- Issues: `DUPLICATE_CANDLE`, `MISSING_SIGNAL_CANDLE`
