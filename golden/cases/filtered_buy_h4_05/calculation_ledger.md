# Calculation ledger: filtered_buy_h4_05

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H4 BUY Filter matched while the BUY technical signal is false (variant 5).
...
- BUY pivot / window extreme: `217.5` / `217.5`
- SELL pivot / window extreme: `230.0` / `230.0`
