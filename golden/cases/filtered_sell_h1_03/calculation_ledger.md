# Calculation ledger: filtered_sell_h1_03

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H1 SELL Filter matched while the SELL technical signal is false (variant 3).
...
- BUY pivot / window extreme: `170.0` / `170.0`
- SELL pivot / window extreme: `182.5` / `182.5`
