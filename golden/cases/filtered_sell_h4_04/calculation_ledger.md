# Calculation ledger: filtered_sell_h4_04

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H4 SELL Filter matched while the SELL technical signal is false (variant 4).
...
- BUY pivot / window extreme: `195.0` / `195.0`
- SELL pivot / window extreme: `207.5` / `207.5`
