# Calculation ledger: equal_close_filter_boundary_h4

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H4 completed signal includes the D1 candle closing at the identical UTC timestamp.
- Evaluation boundary: `2026-01-11T00:00:01Z`
- Signal timeframe: `H4`
- Data status: `READY`
- Coverage: `equal_close_d1_boundary`, `completed_as_of_close`, `h4`
