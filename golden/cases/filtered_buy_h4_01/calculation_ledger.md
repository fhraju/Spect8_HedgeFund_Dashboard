# Calculation ledger: filtered_buy_h4_01

- Strategy: `SPECT8_MICRO_DAILY_V1_0`
- Description: H4 BUY Filter matched while the BUY technical signal is false (variant 1).
...
- BUY pivot / window extreme: `117.5` / `117.5`
- SELL pivot / window extreme: `130.0` / `130.0`
